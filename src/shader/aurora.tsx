...
declare module '@react-three/fiber' {
  interface ThreeElements {
    auroraMaterial: Object3DNode<AuroraMaterial, typeof AuroraMaterial>;
  }
}
...
export default function Aurora() {
  ...
  return (
    <mesh ref={mesh}>
      <planeBufferGeometry args={[size.width * 0.9, size.height * 0.84]} />
      <auroraMaterial iResolution={[size.width * 0.9, size.height * 0.84, 1]} />
    </mesh>
  );
}
