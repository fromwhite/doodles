...
export default class extends Event {
    ...
    hook(){
        ...
        // 字符串 加载单个图像 await im.loadTexture('../assets/tex.jpg')
        // 数组 加载图片队列 await im.loadTex(['../assets/tex.jpg'])
        // function 回调loading处理
        // glsl 加载着色器
        switch (getType(this.args)) {
            case 'string':console.log('string');this.load();break;
            case 'array':console.log('array');break;
            case 'function':console.log('function');break;
            case 'null':console.log('null');break;
            default : console.log('unkonw argments!')
        }
